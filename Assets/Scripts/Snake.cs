...
public class Snake : MonoBehaviour {
    ...
    private void HandleGridMovement() {
        ...
        if (gridMoveTimer >= gridMoveTimerMax) {
            ...
            default:
            case Direction.Right:   gridMoveDirectionVector = new Vector3(+0.05f, 0); break;
            case Direction.Left:    gridMoveDirectionVector = new Vector3(-0.05f, 0); break;
            case Direction.Up:      gridMoveDirectionVector = new Vector3(0, +0.05f); break;
            case Direction.Down:    gridMoveDirectionVector = new Vector3(0, -0.05f); break;
            }
